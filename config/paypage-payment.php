    ...
    'payments' => [
        ...
        'gateway_configuration' => [
            ...
            'paystack' => [
                ...
                'currencySymbol'              => '₦',
                'paystackTestingSecretKey'         => env('paystackTestingSecretKey'), //paystack testing secret key
                'paystackTestingPublicKey'         => env('paystackTestingPublicKey'), //paystack testing public key
...
'stripeTestingSecretKey'    => env('STRIPE_TESTING_SECRET_KEY'), // Stripe testing Secret Key
'stripeTestingPublishKey'   => env('STRIPE_TESTING_PUBLISH_KEY'), // Stripe testing Publish Key
