        ...
        <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="my-auto">
                    <?php
                        ...
                        $appName = DB::table('systemflag')
                            ...
                            ->first();
                    ?>
                    <img alt="AstroGuru image" class="-intro-x w-1/2 -mt-16" src="/<?php echo e($logo->value); ?>"
                        style="height: 200px;width: 200px;border-radius:50%">
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-3"><?php echo e($appName->value); ?></div>
            ...
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <img alt="AstroGuru image" class="-intro-x w-1/2 -mt-16 xl:hidden" src="/<?php echo e($logo->value); ?>"
...
<?php echo $__env->make('../layout/' . $layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/arch/Downloads/astroway-astrology-consultation-app-with-php-backend-audiovideo-calls-chat-with-live-streaming (2)/Backend-PHP/Astroway-Backend-PHP-master/resources/views/pages/login.blade.php ENDPATH**/ ?>