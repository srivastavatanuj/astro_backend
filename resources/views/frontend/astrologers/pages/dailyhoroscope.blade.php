...
@section('content')
    ...
    <div class="astroway-menu pt-3 bg-pink mt-50">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                                ...
                                <div class="w-100">
                                    <div class="pt-0 mb-1">
                                        ...
                                        <a class="btn m-1 bg-white color-red border-red font-14 font-weight-semi-bold titlecase rounded-25 px-md-4 hover-border-red"
                                            ...
                                            <span class="d-none d-md-inline-block">2024</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade show active" id="dailyData">
                                ...
                                <h2 class="cat-heading mb-4">Free <span
                                    ...
                                    Daily
                                    Horoscope, {{ $horoscope['vedicList']['todayHoroscope'][0]['date'] }}
                                </h2>
                            ...
                            <div class="col-12 pt-4 mt-3 tab-pane fade" id="weeklyData">
                                ...
                                <h2 class="cat-heading mb-4">Free <span
                                    ...
                                    Weekly
                                    Horoscope, {{ $horoscope['vedicList']['weeklyHoroScope'][0]['start_date'] }} To
                                    {{ $horoscope['vedicList']['weeklyHoroScope'][0]['end_date'] }}
                                </h2>
                                <div class="d-md-flex align-items-start ">
                                    <img src="/{{ $signRcd[0]->image }}" style="max-height: 140px"
                                        class="mr-md-3 mx-auto d-block" alt="Aries">
