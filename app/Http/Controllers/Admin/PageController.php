...
class PageController extends Controller
{
    ...
    {
        return view('pages/add-astrologer');
    }
    ...
    public function astrologerCategoryList()
    {
        return view('pages/astrologer-category-list');
    }
    public function hororScopeSignList()
    {
    ...
    {
        return view('pages/commission-type');
    }
    public function helpSupport()
    {
        return view('pages/help-support');
    }
    public function helpSupportSubCategory()
    {
        return view('pages/help-support-queston-answer');
    }
    public function helpSupportQuestonAnswer()
    {
        return view('pages/help-support-queston-answer');
    }
    public function systemFlag()
    {
        return view('pages/system-flag');
    }
    ...
    {
        return view('page/call-history-report');
    }
    public function chatHistory()
    {
        return view('page/chat-history-report');
    }
    public function orderrequest()
    {
        return view('page/order-request');
    }
    ...
    public function reportBlock()
    {
        return view('pages/reportBlock');
    }
    public function dailyHoroscope()
    {
        return view('pages/daily-horoscope');
    }
