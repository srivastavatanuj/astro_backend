                            ...
                            <div class="dropdown ml-3">
                                ...
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        ...
                                        <li>
                                            <a id="editbtn" href="javascript:;" onclick="deletebtn({{ $blog['id'] }})"
                                                class="dropdown-item" data-tw-target="#delete-confirmation-modal"
                                                data-tw-toggle="modal" data-tw-dismiss="dropdown"><i data-lucide="trash-2"
                                                    class="editbtn w-4 h-4 mr-2"></i>Delete
                                                Blog</a>
                                        </li>
                                    </ul>
                                </div>
