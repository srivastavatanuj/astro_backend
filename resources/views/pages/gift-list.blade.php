                ...
                <tbody>
                    ...
                    @foreach ($gifts as $gift)
                        <tr class="intro-x">
                            ...
                            <td>
                                <div class="flex">
                                    <div class="w-10 h-10 image-fit zoom-in">
                                        <img class="rounded-full" src="/{{ $gift['image'] }}"
                            ...
                            <td class="text-center">{{ $currency->value }}{{ $gift['amount'] }}</td>
                            <td class="w-40">
                                <div
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a id="editbtn" href="javascript:;"
                                        onclick="editbtn({{ $gift['id'] }} , '{{ $gift['name'] }}','{{ $gift['image'] }}', '{{ $gift['amount'] }}')"
...
@section('script')
    <script type="text/javascript">
        function editbtn($id, $name, $image, $amount) {
