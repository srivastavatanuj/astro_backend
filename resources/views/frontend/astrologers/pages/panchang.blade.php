                                    ...
                                    <div class="pt-0 mb-1">
                                        <a class="card-link btn m-1 bg-white text-dark border-red font-14 font-weight-semi-bold titlecase rounded-25 mt-2"
                                            ...
                                            href="#card-element-1">Calendar&nbsp;<i class="fa fa-caret-down"
                                                ...
                                                @endphp
                                       <a class="btn m-1 {{ $todayActive ? 'bg-red text-white' : 'bg-white text-dark' }} border-red font-14 font-weight-semi-bold titlecase rounded-25 mt-2" href="{{ route('front.getPanchang')}}">TODAY&nbsp;
                                        </a>
                                            <a class="btn m-1 {{ $tomorrowActive ? 'bg-red text-white' : 'bg-white text-dark' }} border-red font-14 font-weight-semi-bold titlecase rounded-25 mt-2" href="{{ route('front.getPanchang', ['panchangDate' => date('Y-m-d', strtotime('+1 day'))]) }}">TOMORROW&nbsp;
                                          </a>
                                    </div>
                                            ...
                                            <div class="px-3 pb-1 rounded shadow-pink">
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center pt-2 pb-3">
                                                            ...
                                                            <a href="{{ route('front.getPanchang')}}" class="monthbox high">{{date('M')}}</a>
                                                    ...
                                                    @for ($day = 1; $day <= $daysInMonth; $day++)
                                                            ...
                                                            @endphp
                                                            <a href="{{ route('front.getPanchang', ['panchangDate' => $fullDate]) }}" class="daybox p-1 m-1{{ request('panchangDate', date('Y-m-d')) == $fullDate ? ' high' : '' }}">{{ $day }}</a>
                                                        @endfor
                                                    </div>
                                                </div>
                                            </div>
